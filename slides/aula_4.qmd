...
Criado por Leo Breiman em 2001: <https://doi.org/10.1023/A:1010933404324>
...
O comando `set.seed()` fixa a 'semente' do gerador de números aleatórios.

-   É muito dificil criar um mecanismo computacional para gerar números realmente aleatórios.
-   Computadores usam algoritmos que geram números *pseudo-aleatórios*.
-   A partir de um valor inicial, aplicam uma série de cálculos instáveis, que resultam em números completamente diferentes mesmo se a semente for bem similar.
-   Sem uma especificação de semente, o computador usa o horário como semente.
...
-   *Label Encoding*: substuir categorias por números inteiros (menos importante no R).
...
Por definição, se costuma usar as linhas para a 'verdade' e as colunas para o predito. 
...
Acurácia Global = `r round((26 + 30) / (26+3+6+30),3)` Kappa = `r k`.
...
::::: columns
::: {.column width="50%"}
![](../figs/auc_0-5.png) ![](../figs/auc_0-65.png)
:::

::: {.column width="50%"}
![](../figs/auc_0-93.png) ![](../figs/auc_1-0.png)
:::
:::::
...
Caso 1: Deteção de Spam - é melhor deixar um e-mail real cair no SPAM do colocar SPAM na caixa de entrada.
...
Essa fórmula prioriza valores balanceados das duas métricas.
